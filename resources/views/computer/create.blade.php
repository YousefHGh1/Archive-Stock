                ...
                <div class="card card-custom gutter-b example example-compact">
                    <div class="card-header">
                        <div class="card-title">
                            <h3 class="card-label"> بيانات وارد الحاسوب <i class="mr-2"></i></h3>
                        </div>
                        <div class="card-toolbar">

                            <a href="https://master/CoreArchive/public/computer" class="btn btn-info font-weight-bolder">
                                <span class="svg-icon svg-icon-md">
                                    ...
                                    <!--end::Svg Icon-->
                                </span>عرض وارد الحاسوب</a>
                        </div>
                    </div>
                    <!--begin::Form-->
                    <form action="{{ route('computer.store') }}" method="post" class="form needs-validation " novalidate
