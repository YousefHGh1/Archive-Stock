                ...
                <div class="card card-custom gutter-b example example-compact">
                    <div class="card-header">
                        <div class="card-title">
                            <h3 class="card-label"> بيانات الفواتير (سند صرف) <i class="mr-2"></i></h3>
                        </div>
                                    ...
                                    <div class="input-group">
                                        <select name="subSection_id" id="subSection_id"
                                            ...
                                            @if ($errors->has('subSection_id'))
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $errors->first('subSection_id') }}</strong>
                                                </span>
                                            @endif
                                        </select>
                                    </div>
    ...
    <script>
        $(document).ready(function() {
            $('select[name="subSection_id"]').on('change', function() {
                var subSection_id = $(this).val();
                if (subSection_id) {
                    $.ajax({
                        url: "{{ URL::to('getUsers') }}/" + subSection_id,
                        type: "GET",
                        dataType: "json",
