            ...
            <div class="flex-wrap pb-0 border-0 card-header">
                <div class="card-title">
                    <div data-toggle="collapse" data-target="#collapseOne5"
                        class="btn btn-info advance_search font-weight-bolder"><i class="flaticon-technology"></i>
                        تقارير الأصناف
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div id="collapseOne5" class="pl-5 collapse" data-parent="#accordionExample5">
                        ...
                        <div class="mb-6 col-lg-12">
                            <form action="{{ route('transactions_report') }}" method="GET" class="pl-5 form-group">
                                @csrf
                                <div class="form-group row">
                                    <!-- Category Search -->
                                    <div class="pl-5 pr-5 col-3">
                                        <select name="category_name" class="form-control selectpicker"  data-live-search="true" title="اختر العائلة...">
                                    ...
                                    {{-- <div class="pl-5 pr-5 col-2">
                                        ...
                                        <select name="category_num" class="form-control selectpicker" data-live-search="true" title="اختر العائلة...">
                                    ...
                                    <div class="mt-auto mb-auto col-lg-2">
                                        <a href="{{ route('transactions_report') }}"
                                            class="btn btn-danger btn-danger--icon">تنظيف
                                            البحث</a>
                                    </div>
                                </div>
                            </form>
