        ...
        <div class="card card-custom">
            <div class="flex-wrap pb-0 border-0 card-header">
                <div class="card-title">
                    <h3 class="card-label">عرض العهد </h3>
                </div>
                <div class="card-toolbar">
                    <!--begin::Button-->
                    <a href="{{ url('/inventory/custody/create') }}" class="btn btn-success font-weight-bolder">
            ...
            <div class="card-body">
                        ...
                        <div id="collapseOne5" class="pl-5 collapse" data-parent="#accordionExample5"
                            ...
                            <div class="card-body1">
                                <div class="mb-6 col-lg-9">
                                    <label>التاريخ:</label>
                                    <form action="{{ url('inventory/custody/searchdate') }}" method="POST"
                ...
                <table id="example" class="table dt-responsive" style="width:100%">
                    <thead class="thead_dark">
                        <tr>
                            <th width="8%">رقم العهدة</th>
                            <th width="14%">الدائرة</th>
                            <th width="14%"> القسم</th>
                            <th width="19%"> الموظف</th>
                            <th width="22%">الأصناف</th>
                            <th width="10%">تاريخ العهدة</th>
                    ...
                    <tbody>
                        @foreach ($custody as $custodies)
                            <tr>
                                ...
                                <td>{{ $custodies->name_section }}</td>
                                <td>{{ $custodies->name }}</td>
                                <td>{{ $custodies->employee_name }}</td>
                                ...
                                <td data-field="Actions" data-autohide-disabled="false" aria-label="null"
                                    ...
                                    <span style="overflow: visible; position: relative; width: 110px;">
                                        ...
                                        <a href="{{ url('/inventory/custody/' . $custodies->id) }}"
                                            title="View custodies"><button class="btn btn-sm btn-clean btn-icon"> <svg
