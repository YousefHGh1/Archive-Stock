                ...
                <div class="card card-custom gutter-b example example-compact">
                    <div class="card-header">
                        <div class="card-title">
                            <h3 class="card-label"> بيانات وارد الرقابة <i class="mr-2"></i></h3>
                        </div>
                        <div class="card-toolbar">

                            <a href="https://master/CoreArchive/public/censorship" class="btn btn-info font-weight-bolder">
                                <span class="svg-icon svg-icon-md">
                                    ...
                                    <!--end::Svg Icon-->
                                </span>عرض وارد الرقابة</a>
                        </div>
                    </div>
                    <!--begin::Form-->
                    <form action="{{ route('censorship.store') }}" method="post" class="form needs-validation " novalidate
                        enctype="multipart/form-data" id="kt_form">
                        @csrf
                        {!! csrf_field() !!}
                        <div class="card-body " style="margin-right: 3%; margin-left:0%; padding-left:0%; margin-top:2%;">
                                ...
                                <div class="col-lg-3">
                                    <div class="input-group">
                                        <input name="number" type="number" min="0" class="@error('number') is-invalid @enderror form-control"
                                            id="number" placeholder="ادخل رقم الوارد" />
                                    </div>
                                </div>
