        ...
        <div class="card card-custom">
            <div class="flex-wrap pb-0 border-0 card-header">
                <div class="card-title">
                    <h3 class="card-label">عرض جهات الوارد </h3>
                </div>
                <div class="card-toolbar">
                    <!--begin::Button-->
                    <a href="{{ url('import/create') }}" class="btn btn-primary font-weight-bolder">
                        <span class="svg-icon svg-icon-md">
                            ...
                            <!--end::Svg Icon-->
                        </span>إنشاء جهة وارد</a>
                    <!--end::Button-->
                    <!--begin::Button-->
                    <a href="{{ url('/archive/create') }}" class="ml-5 btn btn-primary font-weight-bolder">
                        <span class="svg-icon svg-icon-md">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Flatten.svg-->
            ...
            <div class="card-body">
                ...
                <table id="example" class="table dt-responsive" style="width:100%">
                    <thead class="thead_dark">
                        <tr>
                            <th width="50%">{{ 'اسم الجهة الموردة' }}</th>
                            <th width="30%">{{ 'رقم الجهة الموردة' }}</th>
                    ...
                    <tbody>
                        @foreach ($import as $imports)
                            <tr>
                                ...
                                <td> {{ $imports->import_num }}</td>

                                <td data-field="Actions" data-autohide-disabled="false" aria-label="null"
                                    class="datatable-cell">
                                    <span style="overflow: visible; position: relative; width: 110px;">

                                        {{-- <a href="#" onclick="confirmDelete('{{ $imports->id }}', this)"
                                        class="btn btn-sm btn-clean btn-icon" title="Delete"><i
                                            class="la la-trash"></i></a> --}}

                                        <form method="POST" action="{{ url('/import' . '/' . $imports->id) }}"
                                        ...
                                        <a href="{{ url('/import/' . $imports->id . '/edit') }}"
