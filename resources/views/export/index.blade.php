        ...
        <div class="card card-custom">
            <div class="flex-wrap pb-0 border-0 card-header">
                <div class="card-title">
                    <h3 class="card-label">عرض جهات الصادر  </h3>
                </div>
                <div class="card-toolbar">
                    <!--begin::Button-->
                    <a href="{{ url('export/create') }}" class="btn btn-primary font-weight-bolder">
                        <span class="svg-icon svg-icon-md">
                            ...
                            <!--end::Svg Icon-->
                        </span>إنشاء جهة صادر اليها</a>
                    <!--end::Button-->
                    <!--begin::Button-->
                    <a href="{{ url('/archiveExport/create') }}" class="ml-5 btn btn-primary font-weight-bolder">
                        <span class="svg-icon svg-icon-md">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Flatten.svg-->
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
            ...
            <div class="card-body">
                ...
                <table id="example" class="table dt-responsive" style="width:100%">
                    <thead class="thead_dark">
                        <tr>
                            <th width="50%">{{ 'اسم الجهة ' }}</th>
                            <th width="30%">{{ 'رقم الجهة ' }}</th>
                    ...
                    <tbody>
                        @foreach ($export as $exports)
                            <tr>
                                ...
                                <td> {{ $exports->export_num }}</td>

                                <td data-field="Actions" data-autohide-disabled="false" aria-label="null"
                                    class="datatable-cell">
                                    <span style="overflow: visible; position: relative; width: 110px;">

                                        {{-- <a href="#" onclick="confirmDelete('{{ $exports->id }}', this)"
                                        class="btn btn-sm btn-clean btn-icon" title="Delete"><i
                                            class="la la-trash"></i></a> --}}

                                        <form method="POST" action="{{ url('/export' . '/' . $exports->id) }}"
                                        ...
                                        <a href="{{ url('/export/' . $exports->id . '/edit') }}"
