        ...
        <div class="card card-custom">
            <div class="flex-wrap pb-0 border-0 card-header">
                <div class="card-title">
                    <h3 class="card-label"> بيانات البريد الصادر : {{ App\Models\ArchiveExport::count() }} </h3>
                    <div class="pt-3 btn-group">
                        <form action="{{ route('archiveExport.index') }}" method="GET">
            ...
            <div class="card-body">
                ...
                <table id="example" class="table dt-responsive" style="width:100%">
                    <thead class="thead_dark">
                        <tr>
                            <th width="6%">{{ 'رقم الصادر' }}</th>
                            <th width="8%">{{ 'تاريخ الصادر ' }} </th>
                            <th width="18%">{{ 'الجهة الصادر اليها' }}</th>
                            <th width="22%">{{ 'عنون الموضوع' }}</th>
                            <th width="22%">{{ 'مرفق الصادر' }}</th>
                    ...
                    <tbody>
                        @foreach ($archiveExport as $archiveExports)
                            <tr>
                                ...
                                <td>
                                    @if ($archiveExports->files)
                                        @foreach (json_decode($archiveExports->files) as $file)
                                ...
                                <td data-field="Actions" data-autohide-disabled="false" aria-label="null"
                                    ...
                                    <span style="overflow: visible; position: relative; width: 110px;">
                                        ...
                                        <a href="{{ url('/archiveExport/' . $archiveExports->id . '/edit') }}"
