            ...
            <div class="card">
                ...
                <div id="collapseOne5" class="pl-5 collapse" data-parent="#accordionExample5">
                    <div class="mb-6 row">
                        <div class="col-lg-6">
                            <label>التاريخ:</label>
                            <form action="{{ route('historical.searchdate') }}" method="POST" class="form-group">
                                @csrf
                        ...
                        <div class="col-lg-3">
                            <label>الايصال:</label>
                            <form action="{{ route('historical.searchsec') }}" method="POST" class="form-group">
                                @csrf
                                <div class="input-daterange input-group">
                                    <div class="p-0 col-4">
                        ...
                        <div class="col-lg-3">
                            <label>السند:</label>
                            <form action="{{ route('historical.searchvou') }}" method="POST" class="pr-5 form-group">
                                @csrf
                                <div class="input-daterange input-group">
                                    <div class="p-0 col-4">
                    ...
                    <div class="mb-6 col-lg-12">
                        <form action="{{ route('historical.searchname') }}" method="POST" class="pl-5 form-group">
                            @csrf
        ...
        <div class="card card-custom">
            <div class="flex-wrap pt-5 pb-0 border-0 card-header">
                ...
                <div class="card-toolbar">
                    <!--begin::Dropdown-->
                    <a class="mr-5 btn btn-dark" href="{{ url('/totalreport') }}">تقارير المجاميع </a>
                    <!--end::Button-->
                </div>
            </div>
            {{-- *********************** --}}
