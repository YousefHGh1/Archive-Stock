                        ...
                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                            ...
                            <ul class="py-2 navi flex-column navi-hover">
                                <li class="pb-2 navi-header font-weight-bolder text-uppercase font-size-sm text-primary">
                                    اختر:</li>
                                <li class="navi-item">
                                    <a href="{{ route('historical.waredreport') }}" class="navi-link">
                    ...
                    <tbody class="datatable-body">
                        @foreach ($diesel as $diesels)
                            <tr data-row="0" class="datatable-row" style="left: 0px;">
                                ...
                                style="width: 10px;">{{$diesels->typesfuel->name}}</span></td>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    ...
                                    {{ \App\Models\Diesel::select('quantity')->whereRaw('MONTH(diesels.date) = 1 && YEAR(diesels.date) = 2022')->sum('quantity') }}
                                    <span>لتر</span>
                                    </li>
                                </td>
                                ...
                                <td>
                                    {{-- <li class="list-group-item">  --}}
                                    {{ \App\Models\Diesel::select('quantity')->whereRaw('MONTH(diesels.date) = 2 && YEAR(diesels.date) = 2022')->sum('quantity') }}
                                    <span>لتر</span>
                                </td>

                                <td>
                                    {{-- <li class="list-group-item">  --}}
                                    {{ \App\Models\Diesel::select('quantity')->whereRaw('MONTH(diesels.date) = 3 && YEAR(diesels.date) = 2022')->sum('quantity') }}
                                    <span>لتر</span>
                                </td>

                                <td>
                                    {{-- <li class="list-group-item">  --}}
                                    {{ \App\Models\Diesel::select('quantity')->whereRaw('MONTH(diesels.date) = 4 && YEAR(diesels.date) = 2022')->sum('quantity') }}
                                    <span>لتر</span>
                                </td>

                                <td>
                                    {{-- <li class="list-group-item">  --}}
                                    {{ \App\Models\Diesel::select('quantity')->whereRaw('MONTH(diesels.date) = 5 && YEAR(diesels.date) = 2022')->sum('quantity') }}
                                    <span>لتر</span>
                                </td>

                                <td>
                                    {{-- <li class="list-group-item">  --}}
                                    {{ \App\Models\Diesel::select('quantity')->whereRaw('MONTH(diesels.date) = 6 && YEAR(diesels.date) = 2022')->sum('quantity') }}
                                    <span>لتر</span>
                                </td>

                                <td>
                                    {{-- <li class="list-group-item">  --}}
                                    {{ \App\Models\Diesel::select('quantity')->whereRaw('MONTH(diesels.date) = 7 && YEAR(diesels.date) = 2022')->sum('quantity') }}
                                    <span>لتر</span>
                                </td>

                                <td>
                                    {{-- <li class="list-group-item">   --}}
                                    {{ \App\Models\Diesel::select('quantity')->whereRaw('MONTH(diesels.date) = 8 && YEAR(diesels.date) = 2022')->sum('quantity') }}
                                    <span>لتر</span>
                                </td>
                                ...
                                <td>
                                    {{-- <li class="list-group-item"> --}}
                                    {{ \App\Models\Diesel::select('quantity')->whereRaw('MONTH(diesels.date) = 9 && YEAR(diesels.date) = 2022')->sum('quantity') }}
                                    <span>لتر</span>
                                </td>
                                ...
                                <td>
                                    {{-- <li class="list-group-item">   --}}
                                    {{ \App\Models\Diesel::select('quantity')->whereRaw('MONTH(diesels.date) = 11 && YEAR(diesels.date) = 2022')->sum('quantity') }}
                                    <span>لتر</span>
                                </td>

                                <td>
                                    {{-- <li class="list-group-item">   --}}
                                    {{ \App\Models\Diesel::select('quantity')->whereRaw('MONTH(diesels.date) = 12 && YEAR(diesels.date) = 2022')->sum('quantity') }}
                                    <span>لتر</span>
                                </td>

                                <td>
                                    {{ \App\Models\Diesel::select('id')->whereRaw('YEAR(diesels.date) = 2022')->count('id') }}
                                    </li>
                                </td>
                                <td> {{ \App\Models\Diesel::select('quantity')->whereRaw('YEAR(diesels.date) = 2022')->sum('quantity') }}
                                    <span>لتر</span> </li>
                                </td>
