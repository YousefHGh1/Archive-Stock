...
@section('title', 'عرض الوارد التاريخي')
        ...
        <div class="card card-custom">
            <div class="flex-wrap pt-5 pb-0 border-0 card-header">
                <div class="card-title">
                    <h3 class="card-label">تقارير وارد المحروقات التاريخي</h3>
                </div>
                ...
                <div class="card">
                    ...
                    <div id="collapseOne5" class="pl-5 collapse" data-parent="#accordionExample5">
                        <div class="row card-body1">
                            ...
                            <div class="col-lg-12">
                                <form action="{{ route('historical.waredindex') }}" method="POST" class="pr-5 form-group">
                                    @csrf
                                    <!-- Date Range Inputs -->
