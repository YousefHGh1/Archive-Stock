                ...
                <div class="card card-custom gutter-b example example-compact">
                    <div class="card-header">
                        <div class="card-title">
                            <h3 class="card-label"> بيانات صادر الرقابة <i class="mr-2"></i></h3>
                        </div>
                        <div class="card-toolbar">

                            <a href="https://master/CoreArchive/public/censorshipExport"
                                ...
                                <span class="svg-icon svg-icon-md">
                                    ...
                                    <!--end::Svg Icon-->
                                </span>عرض صادر الرقابة</a>
                        </div>
                    </div>
                    <!--begin::Form-->
                    <form action="{{ route('censorshipExport.store') }}" method="post" class="form needs-validation "
                                ...
                                <div class="col-lg-3">
                                    <div class="input-group1">
                                        <select class="form-control selectpicker" data-size="7" tabindex="null"
                                            data-live-search="true" title="ادخل الجهة الصادر إليها ..." name="export_id"
                                            id="export_id">
