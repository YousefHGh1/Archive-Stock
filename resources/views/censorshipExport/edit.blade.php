        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    ...
                    <!--begin::Form-->
                    <form action="{{ route('censorshipExport.update', $censorshipExport->id) }}" method="post"
                        ...
                        <div class="card-body" style="margin-right: 2%; margin-left:0%; padding-left:0%; margin-top:1%;">
                       
                            <div class="form-group row p-3">
                                  <label for="title" class="col-lg-2 col-form-label "><h6><strong>عنوان الموضوع:</strong></h6></label>
                                  <div class="col-lg-9">
                                      <div class="input-group">
                                          <input name="title" id="title" type="text" class="form-control"  min="0"  value="{{ $censorshipExport->title }}" >
                                      </div>
                                  </div>
                            </div>
                              ...
                              <div class="form-group row p-3">
                                  ...
                                  <div class="dropdown bootstrap-select form-control dropup col-lg-9" >
                                      <select class="form-control selectpicker" name="export_id" required id="export_id">
                                          ...
                                          <option value="{{ $exports->id }}" {{$censorshipExport->export_id == $exports->id  ? 'selected' : ''}}>{{ $exports->export_name}}</option>
                                          @endforeach
                                      </select>
                                  </div>
                              </div>
                              ...
                              <div class="form-group row p-3">
                                  ...
                                  <div class="col-lg-9">
                                      <div class="input-group">
                                          <input  name="number" type="number" min="0" class="form-control" id="number" value="{{ $censorshipExport->number }}"  />
                                      </div>
                                  </div>
                              </div>
                              ...
                              <div class="form-group row p-3">
                                  ...
                                  <div class="col-lg-9">
                                      <div class="input-group">
                                          <input  name="date" type="date"  class="form-control" id="date"  value="{{ $censorshipExport->date }}"  />
                                      </div>
                                  </div>
                              </div>
                              ...
                              <div class="form-group row p-3">
                                ...
                                <div class="col-lg-9">
                                    <div class="input-group">
                                        <input  name="file" type="file" min="0" class="form-control" id="file"  value="{{ $censorshipExport->file }}"  />       
                                    </div>
                                </div>
                            </div>
