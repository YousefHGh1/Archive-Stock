...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card card-custom gutter-b example example-compact">
            ...
            <!--begin::Form-->
            <form action="{{route('supplier.update', $supplier->id)}}" method="post" class="needs-validation" novalidate
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-6">
                            <input  name="name_supplier" type="text" class="form-control" id="name_supplier" value="{{ $supplier->name_supplier }}"  />
                        </div>
                    </div>
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-6">
                            <input name="num_supplier" type="number" class="form-control" id="num_supplier" value="{{ $supplier->num_supplier }}"   />
                        </div>
                    </div>
