                    ...
                    <div class="p-5 row justify-content-center">
                        <div class="col-md-12">
                            ...
                            <div class="pb-5 row">
                                <div class="col-md-8 border-right-md pr-md-10 py-md-10">
                                    ...
                                    <div class="  font-size-lg font-weight-bold d-flex justify-content-between"> طالب
                                        ...
                                        يمثلهاالسيد / أ.مازن النجار رئيس البلدية<br />
                                    ...
                                    <div class="pt-5">
                                        ...
                                        <h6> حيث أن / المذكور أعلاه دفع كامل المبلغ في البلدية على القضية التنفيذية المرقومة أعلاه.<br/>
                            ...
                            <div class="mb-5 font-size-lg font-weight-boldest d-flex justify-content-around" style="text-align: center;">
                                قرار <br>
                                أقرر إجابة الطلب مع الجهات المختصة بذلك حسب الأصول<br>
                                قاضي التنفيذ
