                ...
                <div class="card card-custom gutter-b example example-compact">
                    <div class="card-header">
                        <div class="card-title">
                            <h3 class="card-label"> بيانات وراد الجباية <i class="mr-2"></i></h3>
                        </div>
                    ...
                    <!--begin::Form-->
                    <form action="{{ route('jibaya.store') }}" method="post" class="form needs-validation " novalidate
                            ...
                            <div class="form-group row p-3">
                                ...
                                <div class="col-lg-3">
                                    <div class="input-group1">
                                        <select class="@error('import_id') is-invalid @enderror form-control selectpicker" data-size="7" tabindex="null"
