                ...
                <div class="card card-custom gutter-b example example-compact">
                    <div class="card-header">
                        <div class="card-title">
                            <h3 class="card-label"> بيانات الرقابة المرسلة <i class="mr-2"></i></h3>
                        </div>
                        <div class="card-toolbar">

                            <a href="https://master/CoreArchive/public/sendNotification/censorshipNot"
                            ...
                            <div class="col-lg-8">
                                <div class="input-group">
                                    <input name="sender" id="sender" type="text" class="form-control"
                                        value="{{ $censorshipNot->sender }}" disabled>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-8">
                                <div class="input-group">
                                    <input name="reciver" type="text" class="form-control" id="reciver"
                                        value="{{ $censorshipNot->reciver }}" disabled />
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-8">
                                <div class="input-group">
                                    <input name="file" type="text" class="form-control" id="file"
                                        value="{{ $censorshipNot->file }}" disabled />
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-8">
                                <div class="input-group">
                                    <input name="description" type="text" class="form-control" id="description"
                                        value="{{ $censorshipNot->description }}" disabled />
                                </div>
                            </div>
                        </div>
