                ...
                <div class="card card-custom gutter-b example example-compact">
                    <div class="card-header">
                        <div class="card-title">
                            <h3 class="card-label"> بيانات الحاسوب المرسلة <i class="mr-2"></i></h3>
                        </div>
                        <div class="card-toolbar">

                            <a href="https://master/CoreArchive/public/sendNotification/computerNot"
                            ...
                            <div class="col-lg-8">
                                <div class="input-group">
                                    <input name="sender" id="sender" type="text" class="form-control"
                                        value="{{ $computerNot->sender }}" disabled>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-8">
                                <div class="input-group">
                                    <input name="reciver" type="text" class="form-control" id="reciver"
                                        value="{{ $computerNot->reciver }}" disabled />
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-8">
                                <div class="input-group">
                                    <input name="file" type="text" class="form-control" id="file"
                                        value="{{ $computerNot->file }}" disabled />
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-8">
                                <div class="input-group">
                                    <input name="description" type="text" class="form-control" id="description"
                                        value="{{ $computerNot->description }}" disabled />
                                </div>
                            </div>
                        </div>
