                ...
                <div class="card card-custom gutter-b example example-compact">
                    <div class="card-header">
                        <div class="card-title">
                            <h3 class="card-label"> بيانات وارد الشؤون القانونية <i class="mr-2"></i></h3>
                        </div>
                        <div class="card-toolbar">

                            <a href="https://master/CoreArchive/public/legal" class="btn btn-info font-weight-bolder">
                                <span class="svg-icon svg-icon-md">
                                    ...
                                    <!--end::Svg Icon-->
                                </span>عرض وارد الشؤون القانونية</a>
                        </div>
                    </div>
                    <!--begin::Form-->
                    <form action="{{ route('legal.store') }}" method="post" class="form needs-validation " novalidate
                            ...
                            <div class="form-group row p-3">
                                ...
                                <div class="col-lg-3">
                                    <div class="input-group1">
                                        <select class="@error('import_id') is-invalid @enderror form-control selectpicker"
                                            data-size="7" tabindex="null" data-live-search="true"
                                            title="ادخل الجهة الوارد منها ..." name="import_id" id="import_id">
                                ...
                                <div class="col-lg-3">
                                    <div class="input-group">
                                        <input name="files[]" type="file" min="0"
                                            class="@error('files') is-invalid @enderror form-control" id="file"
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                            <ul class="nav nav-hover flex-column">
                                                ...
                                                <li class="nav-item">
                                                    <a href="https://master/CoreArchive/public/import/create"
                                                        class="nav-link">
