        ...
        <div class="bg-white login login-1 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid"
            ...
            <div class="login-aside d-flex flex-column flex-row-auto" style="background-color: #F2C98A;">
                ...
                <div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
                    ...
                    <!--begin::Aside title-->
                    <h3 class="text-center font-weight-bolder font-size-h4 font-size-h1-lg" style="color: #852A22;">
                ...
                <div class="aside-img d-flex flex-row-fluid bgi-no-repeat bgi-position-y-bottom bgi-position-x-center">
                    <img src="{{ url('assets/login/login-visual-1.svg') }}" alt="">
                </div>
                <!--end::Aside Bottom-->
            </div>
            <!--begin::Aside-->
                    ...
                    <div class="login-form login-signin">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            {{-- <div class="form-group">
                                ...
                                <input class="h-auto px-6 rounded-lg form-control form-control-solid py-7"
                            ...
                            <div class="form-group">
                                <div class="d-flex justify-content-between mt-n5">
                                    <label class="pt-5 font-size-h6 font-weight-bolder text-dark" for="password"
                                ...
                                <a href="javascript:;" for="remember_me"
                                    style="float: left;padding-top: 7px !important;"
                                    class="pt-5 text-primary font-size-h6 font-weight-bolder text-hover-primary"
                                    id="kt_login_forgot">
                                    هل نسيت كلمة المرور؟
                                </a>

                                {{-- @if (Route::has('register'))
                                    <a href="{{ route('register') }}" for="register"
                                        style="float: right;padding-top: 7px !important;"
                                        class="pt-5 text-primary font-size-h6 font-weight-bolder text-hover-primary"
                                        id="register">
                                        إنشاء حساب
                                    </a>
