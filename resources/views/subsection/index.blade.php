        ...
        <div class="card card-custom">
            <div class="flex-wrap pb-0 border-0 card-header">
                <div class="card-title">
                    <h3 class="card-label">عرض الأقسام </h3>
                </div>
                    ...
                    <div class="mr-2 dropdown dropdown-inline">
                        ...
                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                            ...
                            <ul class="py-2 navi flex-column navi-hover">
                                <li class="navi-item">
                                    <a href="{{ url('/section/create') }}" class="navi-link">
                                        <span class="navi-icon">
                                            <i class="far fa-plus-square"></i>
                                        </span>
                                        <span class="navi-text">إنشاء دائرة جديدة </span>
                                    </a>
                                </li>
                                <li class="navi-item">
                                    <a href="{{ url('/section') }}" class="navi-link">
                                        <span class="navi-icon">
                                            <i class="la la-copy"></i>
                                        </span>
                                        <span class="navi-text">عرض الدوائر </span>
                                    </a>
                                </li>
                            </ul>
                            <!--end::Navigation-->
                ...
                <table id="example" class="table dt-responsive" style="width:100%">
                    ...
                    <tbody>
                        @foreach ($subSection as $subSections)
                            <tr>
                                <td> {{ $subSections->id }}</td>
                                <td> {{ $subSections->name }}</td>
                                <td> {{ $subSections->section->name_section }}</td>
                                ...
                                <td data-field="Actions" data-autohide-disabled="false" aria-label="null"
                                    ...
                                    <span style="overflow: visible; position: relative; width: 110px;">
                                        ...
                                        {{-- <a href="#" onclick="confirmDelete('{{ $subSections->id }}', this)"
                                        class="btn btn-sm btn-clean btn-icon" title="Delete"><i
                                            class="la la-trash"></i></a> --}}

                                        <form method="POST" action="{{ url('/subSection' . '/' . $subSections->id) }}"
                                        ...
                                        <a href="{{ url('/subSection/' . $subSections->id . '/edit') }}"
