...
@section('content')
    ...
    <div class="container">
        <div class="card card-custom card-sticky" id="kt_page_sticky_card">
            ...
            <!--begin::Form-->
            <form action="{{ route('subSection.store') }}" method="post" class="form needs-validation" novalidate
                        ...
                        <div class="col-xl-8">
                            <div class="my-5">
                                ...
                                <div class="form-group row">
                                    <label for="exampleSelectd" class="text-lg col-lg-2 col-form-label"> الدائرة:</label>
                                    <div class="col-10">
