        ...
        <div class="card card-custom">
            <div class="flex-wrap pt-6 pb-0 border-0 card-header">
                ...
                <div class="card-toolbar">
                    ...
                    <!--begin::Button-->
                    <a href="https://master/CoreArchive/public/legalexport/create" class="btn btn-success font-weight-bolder">
                        ...
                        <div id="collapseOne5" class="pl-5 collapse" data-parent="#accordionExample5"
                            ...
                            <div class="card-body1">
                                <div class="mb-6 col-lg-9">
                                    <label>التاريخ:</label>
                                    <form action="{{ url('legalexport/search') }}" method="POST" class="pr-5 form-group">
                                        @csrf
