                ...
                <div class="card card-custom gutter-b example example-compact">
                    <div class="card-header">
                        <div class="card-title">
                            <h3 class="card-label"> بيانات صادر الشؤون القانونية <i class="mr-2"></i></h3>
                        </div>
                        <div class="card-toolbar">

                            <a href="https://master/CoreArchive/public/legalexport" class="btn btn-info font-weight-bolder">
                                <span class="svg-icon svg-icon-md">
                                    ...
                                    <!--end::Svg Icon-->
                                </span>عرض صادر الشؤون القانونية</a>
                        </div>
                    </div>
                    <!--begin::Form-->
                    <form action="{{ route('legalexport.store') }}" method="post" class="form needs-validation " novalidate
                            ...
                            <div class="form-group row p-3">
                                ...
                                <div class="col-lg-3">
                                    <div class="input-group1">
                                        <select class="@error('export_id') is-invalid @enderror form-control selectpicker"
                                            data-size="7" tabindex="null" data-live-search="true"
                                            title="اختر الجهة الصادر اليها ..." name="export_id" id="export_id">
