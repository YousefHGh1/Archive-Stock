        ...
        <div class="card card-custom">
                        ...
                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                            ...
                            <ul class="py-2 navi flex-column navi-hover">
                                <li class="pb-2 navi-header font-weight-bolder text-uppercase font-size-sm text-primary">
                                    اختر:</li>
                                <li class="navi-item">
                                    <a href="{{ route('dieselexport.report') }}" class="navi-link">
                                ...
                                <li class="navi-item">
                                    <a href="{{ route('dieselexport.totalreport') }}" class="navi-link">
                                        <span class="svg-icon svg-icon-primary svg-icon-2x">
                                            <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Communication/Clipboard-list.svg-->
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="20px" height="20px"
            ...
            <div class="card-body">
                ...
                <table class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                    <thead>
                        <tr class="text-uppercase">
                            ...
                            <th style="min-width: 10px">{{ 'رقم السند' }}</th>
                            <th style="min-width: 10px">{{ 'تاريخ الصادر ' }} </th>
                            <th style="min-width: 10px">{{ 'الاجراءات ' }} </th>
                        </tr>
                    </thead>
                    <tbody>
                        @forelse ($dieselexport as $dieselexports)
                            <tr>
                                ...
                                <td class="py-8 pl-0">{{ $dieselexports->date }}</td>
                                <td data-field="Actions" data-autohide-disabled="false" aria-label="null"
                                    class="datatable-cell">
                                    <a href="#" onclick="confirmDelete('{{ $dieselexports->id }}', this)"
                                        class="btn btn-sm btn-clean btn-icon" title="Delete"><i
                                            class="la la-trash"></i></a>

                                    <a href="{{ url('/dieselexport/' . $dieselexports->id . '/edit') }}"
                ...
                {{-- @if ($diesel->links())
                    ...
                    @endif --}}
                {!! $dieselexport->withQueryString()->links('pagination::bootstrap-5') !!}
