        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    ...
                    <!--begin::Form-->
                    <form action="{{ route('employee.update', $employee->id) }}" method="post" class="needs-validation" novalidate
                                ...
                                <div class="col-lg-9">
                                    <div class="input-group">
                                        <input name="employee_name" id="employee_name" type="text" 
                                            class="form-control" value="{{ $employee->employee_name }}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-9">
                                    <div class="input-group">
                                        ...
                                        @foreach ($section as $sections)
                                            <option value="{{ $sections->id }}" {{ $employee->section_id == $sections->id ? 'selected' : '' }}>
                                ...
                                <div class="col-lg-9">
                                    <div class="input-group">
                                        ...
                                        @foreach ($subSection as $subSections)
                                            <option value="{{ $subSections->id }}" {{ $employee->sub_section_id == $subSections->id ? 'selected' : '' }}>
                                                {{ $subSections->name }}
                                            </option>
                                        @endforeach
                                    </select>
