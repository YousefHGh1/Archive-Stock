    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card card-custom gutter-b example example-compact">
                ...
                <!--begin::Form-->
                <form action="{{ route('jibayaexport.update',$jibayaexport->id) }}" method="post" class="needs-validation" novalidate enctype="multipart/form-data">
                @csrf
                {!! csrf_field() !!}
                @method('PUT')
                    <div class="card-body" >
                      ...
                      <div class="form-group row p-3">
                            ...
                            <div class="col-lg-9">
                                <div class="input-group">
                                    <input name="title" id="title" type="text" class="form-control"  min="0"  value="{{ $jibayaexport->title }}" >
                                </div>
                            </div>
                      </div>
                      ...
                      <div class="form-group row p-3">
                        ...
                        <div class="dropdown bootstrap-select form-control dropup col-lg-9" >
                            <select class="form-control selectpicker" name="export_id" required id="export_id">
                                ...
                                <option value="{{ $exports->id }}" {{$jibayaexport->export_id == $exports->id  ? 'selected' : ''}}>{{ $exports->export_name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="form-group row p-3">
                            ...
                            <div class="col-lg-9">
                                <div class="input-group">
                                    <input  name="number" type="number" min="0" class="form-control" id="number" value="{{ $jibayaexport->number }}"  />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row p-3">
                            ...
                            <div class="col-lg-9">
                                <div class="input-group">
                                    <input  name="date" type="date"  class="form-control" id="date"  value="{{ $jibayaexport->date }}"  />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row p-3">
                          ...
                          <div class="col-lg-9">
                              <div class="input-group">
                                  <input  name="file" type="file" min="0" class="form-control" id="file"  value="{{ $jibayaexport->file }}"  />       
                              </div>
                          </div>
                      </div>
