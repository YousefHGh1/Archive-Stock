                ...
                <div class="card card-custom gutter-b example example-compact">
                    <div class="card-header">
                        <div class="card-title">
                            <h3 class="card-label"> بيانات صادر الجباية <i class="mr-2"></i></h3>
                        </div>
                        <div class="card-toolbar">

                            <a href="https://master/CoreArchive/public/jibayaexport" class="btn btn-info font-weight-bolder">
                                <span class="svg-icon svg-icon-md">
                                    ...
                                    <!--end::Svg Icon-->
                                </span>عرض صادر الجباية</a>
                        </div>
                    </div>
                    <!--begin::Form-->
                    <form action="{{ route('jibayaexport.store') }}" method="post" class="form needs-validation "
                                ...
                                <div class="col-lg-3">
                                    <div class="input-group1">
                                        <select class="@error('export_id') is-invalid @enderror form-control selectpicker"
                                            ...
                                            title="ادخل الجهة الصادر إليها ..." name="export_id" id="export_id">
