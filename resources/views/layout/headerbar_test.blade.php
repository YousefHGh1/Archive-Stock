                ...
                <div class="p-0 m-0 dropdown-menu dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    <form>
                        ...
                        <div class="pt-12 d-flex flex-column bgi-size-cover bgi-no-repeat rounded-top"
                            ...
                            {{-- <img src="{{ asset('assets/media/misc/bg-1.jpg') }}" alt=""> --}}
                            <!--begin::Title-->
                            ...
                            <ul class="px-5 mt-3 nav nav-bold nav-tabs nav-tabs-line nav-tabs-line-3x nav-tabs-line-transparent-white nav-tabs-line-active-border-success"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active show" data-toggle="tab"
                                        href="#topbar_notifications_archive">الأرشيف
                                    </a>
                                </li>
                                <li class="nav-item">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="p-8 tab-pane active show" id="topbar_notifications_archive" role="tabpanel">
                                ...
                                <div class="pr-5 scroll mr-n7" data-scroll="true" data-height="300"
                                    ...
                                    @foreach ($archiveNot as $archiveNots)
                                        @if ($archiveNots->reciver == Auth::user()->name)
                                            <div class="mb-6 d-flex align-items-center">
                                                ...
                                                <div class="d-flex flex-column font-weight-bold">
                                                    <a href="{{ url('/sendNotification/archiveNot/' . $archiveNots->id) }}"
                                                        target="_blank"
                                                        class="mb-1 text-dark text-hover-primary font-size-lg">{{ $archiveNots->sender }}</a>


                                                    <a href="{{ url('/sendNotification/archiveNot/' . $archiveNots->id) }}"
                                                        class="text-muted"
                                                        target="_blank">{{ $archiveNots->description }}</a>
                                                    {{-- <a href="#" >{{ $archiveNots->file }}</a> --}}
                                                    <a href="https://master/CoreArchive/public/filearchiveNot/{{ $archiveNots->file }}"
                                                        class="text-muted"
                                                        target="_blank">{{ $archiveNots->file }}</a>
                            ...
                            <!--end::الأرشيف-->
                            <!--begin::الحاسوب-->
                            <div class="p-8 tab-pane" id="topbar_notifications_jibaya" role="tabpanel">
                                <!--begin::Scroll-->
                                <div class="pr-5 scroll mr-n7" data-scroll="true" data-height="300"
                                    data-mobile-height="200">
                                    <!--begin::Item-->
                                    @foreach ($computerNot as $computerNots)
                                        @if ($computerNots->reciver == Auth::user()->name)
                                            <div class="mb-6 d-flex align-items-center">
                                                <!--begin::Symbol-->
                                                <div class="mr-5 symbol symbol-40 symbol-light-primary">
                                                    <span class="symbol-label">
                                                ...
                                                <!--begin::Text-->
                                                <div class="d-flex flex-column font-weight-bold">
                                                    <a href="https://master/CoreArchive/public/filecomputerNot/{{ $computerNots->file }}"
                                                        target="_blank"
                                                        class="mb-1 text-dark text-hover-primary font-size-lg">{{ $computerNots->sender }}</a>
                                                    <a href="https://master/CoreArchive/public/filecomputerNot/{{ $computerNots->file }}"
                                                        class="text-muted"
                                                        target="_blank">{{ $computerNots->description }}</a>
                                                    <a href="https://master/CoreArchive/public/filecomputerNot/{{ $computerNots->file }}"
                                                        class="text-muted"
                                                        target="_blank">{{ $computerNots->file }}</a>
                            ...
                            <!--end::الحاسوب-->
                            <!--begin::الجباية-->
                            <div class="p-8 tab-pane" id="topbar_notifications_censorship" role="tabpanel">
                                <!--begin::Scroll-->
                                <div class="pr-5 scroll mr-n7" data-scroll="true" data-height="300"
                                    data-mobile-height="200">
                                    <!--begin::Item-->
                                    @foreach ($jibayaNot as $jibayaNots)
                                        @if ($jibayaNots->reciver == Auth::user()->name)
                                            <div class="mb-6 d-flex align-items-center">
                                                <!--begin::Symbol-->
                                                <div class="mr-5 symbol symbol-40 symbol-light-primary">
                                                    <span class="symbol-label">
                                                ...
                                                <!--begin::Text-->
                                                <div class="d-flex flex-column font-weight-bold">
                                                    <a href="https://master/CoreArchive/public/filejibayaNot/{{ $jibayaNots->file }}"
                                                        target="_blank"
                                                        class="mb-1 text-dark text-hover-primary font-size-lg">{{ $jibayaNots->sender }}</a>
                                                    <a href="https://master/CoreArchive/public/filejibayaNot/{{ $jibayaNots->file }}"
                                                        class="text-muted"
                                                        target="_blank">{{ $jibayaNots->description }}</a>
                                                    <a href="https://master/CoreArchive/public/filejibayaNot/{{ $jibayaNots->file }}"
                                                        class="text-muted"
                                                        target="_blank">{{ $jibayaNots->file }}</a>
                            ...
                            <!--end::الجباية-->
                            <!--begin::الشؤون-->
                            <div class="p-8 tab-pane" id="topbar_notifications_computer" role="tabpanel">
                                <!--begin::Scroll-->
                                <div class="pr-5 scroll mr-n7" data-scroll="true" data-height="300"
                                    data-mobile-height="200">
                                    <!--begin::Item-->
                                    @foreach ($legalNot as $legalNots)
                                        @if ($legalNots->reciver == Auth::user()->name)
                                            <div class="mb-6 d-flex align-items-center">
                                                <!--begin::Symbol-->
                                                <div class="mr-5 symbol symbol-40 symbol-light-primary">
                                                    <span class="symbol-label">
                                                ...
                                                <!--begin::Text-->
                                                <div class="d-flex flex-column font-weight-bold">
                                                    <a href="https://master/CoreArchive/public/filelegalNot/{{ $legalNots->file }}"
                                                        target="_blank"
                                                        class="mb-1 text-dark text-hover-primary font-size-lg">{{ $legalNots->sender }}</a>
                                                    <a href="https://master/CoreArchive/public/filelegalNot/{{ $legalNots->file }}"
                                                        class="text-muted"
                                                        target="_blank">{{ $legalNots->description }}</a>
                                                    <a href="https://master/CoreArchive/public/filelegalNot/{{ $legalNots->file }}"
                                                        class="text-muted" target="_blank">{{ $legalNots->file }}</a>
                            ...
                            <!--end::الشؤون-->
                            <!--begin::الرقابة-->
                            <div class="p-8 tab-pane" id="topbar_notifications_legal" role="tabpanel">
                                <!--begin::Scroll-->
                                <div class="pr-5 scroll mr-n7" data-scroll="true" data-height="300"
                                    data-mobile-height="200">
                                    <!--begin::Item-->
                                    @foreach ($censorshipNot as $censorshipNots)
                                        @if ($censorshipNots->reciver == Auth::user()->name)
                                            <div class="mb-6 d-flex align-items-center">
                                                <!--begin::Symbol-->
                                                <div class="mr-5 symbol symbol-40 symbol-light-primary">
                                                    <span class="symbol-label">
                                                ...
                                                <!--begin::Text-->
                                                <div class="d-flex flex-column font-weight-bold">
                                                    <a href="https://master/CoreArchive/public/filecensorshipNot/{{ $censorshipNots->file }}"
                                                        target="_blank"
                                                        class="mb-1 text-dark text-hover-primary font-size-lg">{{ $censorshipNots->sender }}</a>
                                                    <a href="https://master/CoreArchive/public/filecensorshipNot/{{ $censorshipNots->file }}"
                                                        class="text-muted"
                                                        target="_blank">{{ $censorshipNots->description }}</a>
                                                    <a href="https://master/CoreArchive/public/filecensorshipNot/{{ $censorshipNots->file }}"
                                                        class="text-muted"
                                                        target="_blank">{{ $censorshipNots->file }}</a>
